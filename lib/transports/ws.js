...
const sockete = require('socket.io-client');
const Transport = require('./transport');

class WebSocketsTransport extends Transport {

    connect(){
        this.client = sockete.connect(this.url);
...
WebSocketsTransport.DEFAULTS = {
    url: 'mqtt://test.mosquitto.org'
};

WebSocketsTransport.ID = 'ws';
WebSocketsTransport.IDS = 'wss';

/*
 * Globally register MqttTransport
 */
require('./transportManager').register(WebSocketsTransport.ID, WebSocketsTransport);
require('./transportManager').register(WebSocketsTransport.IDS, WebSocketsTransport);

module.exports = WebSocketsTransport;
