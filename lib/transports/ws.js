...
WebSocketTransport.DEFAULTS = {
    url: 'wss://echo.websocket.org'
};

WebSocketTransport.ID = 'ws';
WebSocketTransport.IDS = 'wss';

/*
 * Globally register WebSocketTransport
 */
require('./transportManager').register(WebSocketTransport.ID, WebSocketTransport);
require('./transportManager').register(WebSocketTransport.IDS, WebSocketTransport);
